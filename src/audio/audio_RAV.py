...
archivo_txt= '../../resultados/audio/SER_RAV_'+modelo+'_'+featurestr+'.txt'
archivo_h5 = '../../modelos/audio/SER_RAV_'+modelo+'_'+featurestr+'.h5'
...
for train_index, test_index in skf.split(X,y):
    ...
    if modelo!='MLP':
        ...
        cm = confusion_matrix(y_test, pred, labels=[1,2,3,4,5,6,7,8])
